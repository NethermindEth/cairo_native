...
#[test_case("tests/cases/enums/enum_init_empty.cairo")] // fails, mismatch between array<0xi8> and struct<i0, array<0xi8>> (build_init expects a standard enum structure, not the zero size special case)
...
#[test_case("tests/cases/enums/enum_init_nested_empty.cairo")] // fails, as with init_empty
#[test_case("tests/cases/enums/enum_init_nested_multiple.cairo")] // fails, felt mistmatch, 0 != 1234, scalar payload is either not being stored or returned properly
